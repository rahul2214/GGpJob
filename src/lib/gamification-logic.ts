...
export const MILESTONES = [
    { 
        ...
        type: 'level', 
        reward: 20,
        notification: 'Congratulations! 🏆 Reached Level 2. 20 Job Boost Credits added to your wallet!'
    },
    { 
        id: 'level_3_bonus', 
        ...
        type: 'level', 
        reward: 50,
        notification: 'Congratulations! 🏆 Reached Level 3. 50 Job Boost Credits added to your wallet!'
    },
    { 
        id: 'level_4_bonus', 
        ...
        type: 'level', 
        reward: 50,
        notification: 'Congratulations! 🏆 Reached Level 4: Skilled Referrer. 50 Job Boost Credits added to your wallet!'
    },
    { 
        id: 'level_5_bonus', 
        ...
        type: 'level', 
        reward: 100,
        notification: 'Amazing milestone! 🚀 Reached Level 5: Trusted Referrer. 100 Job Boost Credits added!'
    },
    { 
        id: 'level_6_bonus', 
        ...
        type: 'level', 
        reward: 150,
        notification: 'Level 6 achieved! ⚡ 150 Job Boost Credits unlocked for strong performance.'
    },
    { 
        id: 'level_7_bonus', 
        ...
        type: 'level', 
        reward: 300,
        notification: 'Elite status! 🟠 Reached Level 7: Expert Referrer. 300 Job Boost Credits added to your balance.'
    },
    { 
        id: 'level_8_bonus', 
        ...
        type: 'level', 
        reward: 500,
        notification: 'Incredible! 💎 Reached Level 8: Elite Referrer. 500 Job Boost Credits added to your wallet.'
    },
    { 
        id: 'level_9_bonus', 
        ...
        type: 'level', 
        reward: 1000,
        notification: 'Master Status! 🔴 Reached Level 9: Referral Master. 1000 major Job Boost Credits added!'
    },
    { 
        id: 'level_10_bonus', 
        ...
        notification: '👑 LEGENDARY! You have reached Level 10. You are now eligible for the annual boost credit pool and permanent recognition.'
    }
];
...
export async function awardXP(employeeId: string | number, action: keyof typeof ACTION_XP, jobPk?: number) {
    ...
    try {
        const { data: emp, error: fetchErr } = await supabaseAdmin
            .from('employees')
            .select('xp, level, milestones_achieved, credits, verified_referrals_count, badge_ids')
            .eq('id', employeeId)
            .single();
        ...
        return { success: true, xpEarned: totalXpToAward, newLevel, newBalance: updateData.credits };
