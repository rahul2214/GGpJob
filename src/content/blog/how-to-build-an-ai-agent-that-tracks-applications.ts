...
export const post: BlogPost = {
  ...
  faqs: [
    ...
    },
    {
      ...
      a: 'Into a small fixed set, with confidence retained. Low-confidence classifications should surface to the candidate rather than silently setting state — mislabelling an interview invite as a rejection is unrecoverable.',
    },
    {
