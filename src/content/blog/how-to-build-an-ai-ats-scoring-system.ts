...
export const post: BlogPost = {
  ...
  faqs: [
    ...
    },
    {
      ...
      a: 'Through proxies — career gaps, university names, address, phrasing. Test with matched profiles differing in one signal, before launch and on a schedule after.',
    },
  ],
