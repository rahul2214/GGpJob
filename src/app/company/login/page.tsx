...
export default function CompanyLoginPage() {
  ...
  const features = [
    ...
    },
    {
      ...
      desc: "Connect directly with verified candidates across tech, design, and product. Direct messaging allows you to review applications, chat in real-time, and schedule interviews 5x faster.",
          ...
          <div className="relative z-10 space-y-8">
            <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.7, delay: 0.2 }}>
              ...
              <p className="text-emerald-100 text-lg leading-relaxed max-w-sm">
                Post jobs for free, manage candidate pipelines, and connect with qualified talent in minutes.
              </p>
            </motion.div>
