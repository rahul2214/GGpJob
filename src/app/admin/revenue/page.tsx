        ...
        <div className="relative z-10 flex flex-col lg:flex-row lg:items-center justify-between gap-8">
          <div className="space-y-3 max-w-xl">
            <div className="flex items-center gap-2.5 bg-indigo-500/20 px-3.5 py-1.5 rounded-full w-max border border-indigo-400/30">
              ...
              <span className="text-xs font-black uppercase tracking-widest text-indigo-200">Financial Hub & Earnings</span>
            </div>
            <h1 className="text-4xl sm:text-5xl font-black tracking-tight leading-none">Net Revenue & Financial Overview</h1>
            <p className="text-slate-300 text-sm font-medium">
              Real-time platform earnings and order analytics. Complete transparent oversight of business health.
            </p>
          </div>
          ...
          <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-4">
            ...
            <div className="bg-gradient-to-br from-emerald-500/20 to-emerald-600/30 backdrop-blur-md p-6 rounded-2xl border border-emerald-400/30 flex-1 sm:flex-initial">
              <div className="flex items-center justify-between gap-4">
                <span className="text-xs font-black uppercase text-emerald-300 tracking-wider">Gross Platform Revenue</span>
              </div>
              ...
              <div className="text-[11px] font-bold text-emerald-200/80 mt-1 flex items-center gap-1">
                <ArrowUpRight className="w-3.5 h-3.5" /> Total income from active transactions
              </div>
            </div>
          </div>
        </div>
        ...
        <Card className="rounded-3xl border border-slate-100 shadow-xl shadow-slate-100/50 p-6 sm:p-8">
          <CardHeader className="px-0 pt-0 pb-6">
            <div className="flex items-center justify-between">
              <div>
                <CardTitle className="text-xl font-black text-slate-900">Gross Revenue Trend</CardTitle>
                <CardDescription className="text-slate-500 font-medium text-xs mt-1">Monthly progression of incoming revenue.</CardDescription>
              </div>
            </div>
          </CardHeader>
