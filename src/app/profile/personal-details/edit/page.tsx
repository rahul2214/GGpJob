...
export default function MobileEditPersonalDetailsPage() {
            ...
            <Card className="w-full border shadow-sm rounded-3xl overflow-hidden">
                <CardHeader className="px-6 border-b border-slate-50 bg-slate-50/50">
                    <div className="flex items-center gap-3 mb-1">
                        ...
                        <CardTitle className="text-xl">Personal & Diversity Details</CardTitle>
                    </div>
                    <CardDescription>Update your personal details, gender, DOB, and diversity information.</CardDescription>
                </CardHeader>
                <CardContent className="px-5 pt-6 pb-6">
                    <PersonalInfoFormCombined user={user} onSuccess={() => router.push('/profile')} />
                </CardContent>
            </Card>
        </div>
    );
