...
export default function MobileEditResumePage() {
            ...
            <Card className="w-full border shadow-sm rounded-3xl overflow-hidden">
                <CardHeader className="px-6 border-b border-slate-50 bg-slate-50/50">
                    <div className="flex items-center gap-3 mb-1">
                        ...
                        <CardTitle className="text-xl">My Resume</CardTitle>
                    </div>
                    <CardDescription>Upload your resume file or paste your public resume URL.</CardDescription>
                </CardHeader>
