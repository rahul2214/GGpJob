...
import { SingleAchievementForm } from "@/components/single-achievement-form";
...
export default function MobileEditAchievementPage() {
            ...
            <Card className="w-full border shadow-sm rounded-3xl overflow-hidden">
                <CardHeader className="px-6 border-b border-slate-50 bg-slate-50/50">
                    <div className="flex items-center gap-3 mb-1">
                        ...
                        <CardTitle className="text-xl">Edit Achievement</CardTitle>
                    </div>
                    <CardDescription>Update your award, honor, or key accomplishment details.</CardDescription>
                </CardHeader>
                <CardContent className="px-5 pt-6 pb-6">
                    <SingleAchievementForm user={user} itemIndex={id} onSuccess={() => router.push('/profile')} />
                </CardContent>
            </Card>
        </div>
    );
