...
export default function MobileAddAchievementPage() {
            ...
            <Card className="w-full border shadow-sm rounded-3xl overflow-hidden">
                <CardHeader className="px-6 border-b border-slate-50 bg-slate-50/50">
                    <div className="flex items-center gap-3 mb-1">
                        ...
                        <CardTitle className="text-xl">Add Achievement</CardTitle>
                    </div>
                    <CardDescription>Add a new award, honor, or key accomplishment.</CardDescription>
                </CardHeader>
                <CardContent className="px-5 pt-6 pb-6">
                    <SingleAchievementForm user={user} onSuccess={() => router.push('/profile')} />
                </CardContent>
            </Card>
        </div>
    );
