...
export function HeroSection() {
    ...
    return (
        <section id="hero" aria-label="Hero Introduction" className="relative pt-32 pb-24 lg:pt-40 lg:pb-36 overflow-hidden bg-gradient-to-b from-indigo-950 via-slate-900 to-slate-950 text-white">
