...
import type { Job, User, PortalFeedback, Application } from "@/lib/types";
...
type ActiveView = 'users' | 'jobs' | 'portal-feedback' | 'verifications';
...
export default function AdminDashboard() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      setLoading(true);
      try {
        const fetchPromises = [fetchUsers(), fetchJobs(), fetchVerifications()];
